...
3. dim_hotels
        - The pretrained dataset under dim_hotels looks fine and nothing needs to be changed or transformed.
        
4.fact_aggregated_bookings
        - The pretrained dataset under dim_hotels looks fine and nothing needs to be changed or transformed here as well.
        
5.fact_bookings
        - The pretrained dataset under dim_hotels looks fine and nothing needs to be changed or transformed here also.
